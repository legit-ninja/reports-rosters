...
class RosterExportService {
    ...
    private function fetchUsingFieldFilters(array $filters): array {
        ...
        $sql = "SELECT player_name, first_name, last_name, gender, parent_phone, parent_email, age, player_dob, medical_conditions, late_pickup, late_pickup_days, booking_type, day_presence, age_group, activity_type, product_name, camp_terms, course_day, venue, times, shirt_size, shorts_size, avs_number FROM {$table}";
