...
/**
 * Render the main roster editor page (list view)
 */
    ...
    <div class="wrap intersoccer-roster-editor">
        ...
        <div class="intersoccer-filters" style="background: #f9f9f9; border: 1px solid #ddd; border-radius: 4px; padding: 20px; margin: 20px 0;">
            <form method="get" action="<?php echo esc_url(admin_url('admin.php')); ?>" id="roster-editor-filters">
                <input type="hidden" name="page" value="intersoccer-edit-rosters" />
                ...
                <div style="display: flex; gap: 10px;">
                    ...
                    <a href="<?php echo esc_url(admin_url('admin.php?page=intersoccer-edit-rosters')); ?>" class="button">
    ...
    <div class="wrap">
        ...
        <form id="roster-edit-form" method="post" action="">
            ...
            <p class="submit">
                ...
                <a href="<?php echo esc_url(admin_url('admin.php?page=intersoccer-edit-rosters')); ?>" class="button"><?php _e('Cancel', 'intersoccer-reports-rosters'); ?></a>
            </p>
        </form>
    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        window.location.href = '<?php echo esc_js(admin_url('admin.php?page=intersoccer-edit-rosters')); ?>';
                    } else {
