...
function intersoccer_render_reports_page() {
    ...
    // Prepare data for Chart.js (Total Attendees by Region)
    $region_totals = [];
    ...
    <div class="wrap intersoccer-reports-rosters-reports">
            ...
            <div class="filter-section">
                ...
                <div class="filter-row">
                    ...
                    <select name="camp_type" id="camp_type">
                        ...
                        <?php
                        $camp_types = wc_get_product_terms(null, 'pa_age-group', ['fields' => 'names']);
        ...
        <?php if (!empty($report_data)): ?>
            ...
            <!-- Chart: Total Attendees by Region -->
            <div class="filter-section">
    ...
    <!-- Inline JavaScript to pass data to reports-charts.js -->
    <script>
